      ...
      <section className="bg-gray-800 text-white rounded-2xl p-8 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="text-gray-300">{ADRES.ulica}<br/>{ADRES.kodMiasto}</p>
          </div>
          <div>
            <div className="text-3xl mb-2">📞</div>
            <p className="font-semibold">Telefon</p>
            <p className="text-gray-300">{ADRES.telefon}</p>
          </div>
          <div>
            <div className="text-3xl mb-2">🕐</div>
            <p className="font-semibold">Godziny</p>
            <p className="text-gray-300">{ADRES.godzinaOtwarcia}<br/>{ADRES.godzinaSobota}</p>
          </div>
        </div>
